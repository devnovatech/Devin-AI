...
const steps = [
  {
    ...
    description: "Understanding your vision, goals, and requirements through deep discovery sessions.",
    icon: (
  ...
  },
  {
    ...
    description: "Crafting wireframes, prototypes, and technical blueprints that align with your goals.",
    icon: (
  ...
  },
  {
    number: "03",
    title: "Development",
    description: "Bringing designs to life with clean, tested, and scalable code.",
    icon: (
  ...
  },
  {
    number: "04",
    title: "Testing & QA",
    description: "Rigorous quality assurance ensures reliability, security, and performance.",
    icon: (
  ...
  },
  {
    ...
    description: "Launch your product with ongoing support, monitoring, and iteration.",
    icon: (
