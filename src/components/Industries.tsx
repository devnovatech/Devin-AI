        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <AnimatedSection direction="left">
            ...
            <div className="mt-8">
              <a
                href="/industries"
                className="inline-flex items-center gap-2 px-8 py-4 bg-neon-blue rounded-full text-white font-bold tracking-wider text-sm hover:bg-neon-purple hover:shadow-xl hover:shadow-neon-blue/30 transition-all duration-300 hover:scale-105"
              >
              ...
              <AnimatedSection key={industry.name} delay={i * 0.1}>
                ...
                >
                  ...
                  <div className="relative h-full p-6 rounded-2xl border border-deep-blue/5 bg-white/60 group-hover:bg-white group-hover:shadow-lg group-hover:shadow-deep-blue/5 transition-all duration-300 flex flex-col backdrop-blur-sm">
                    {/* Icon */}
                    <div className={`w-14 h-14 rounded-2xl ${industry.color} flex items-center justify-center text-white shadow-lg mb-4`}>
                      {industry.icon}
                    </div>
